package tutorial.hbase.training.mapreduce.job;
...
public class HBaseMapReduceJob implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		hbaseConf.set("hbase.zookeeper.quorum", "kelly1-LIFEBOOK-LH530:2181");
		Job hbaseLoadJob = new Job(hbaseConf);
		hbaseLoadJob.setJobName("Kelly Word Count");
		...
		hbaseLoadJob.getConfiguration().set(TableOutputFormat.OUTPUT_TABLE, "htable12");
