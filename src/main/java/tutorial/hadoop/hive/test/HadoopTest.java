...
public class HadoopTest {
	...
	public static void copyFileFromDFS(FileSystem fs, String srcFile,
			String dstFile) throws IOException {
		try {
			System.out.println("Initialize copy...");
	...
	public static void main(String[] args) {
		try {
			...
			copyFileToDFS(fs, "/home/kelly1/Work/input/wordpair.txt",
					"/input/raptor/trade1.txt");
			//Writing data from HDFS to Local
			 copyFileFromDFS(fs, "/input/raptor/trade1.txt", "/home/kelly1/Work/input/wordpair1.txt");
			end = System.nanoTime();
