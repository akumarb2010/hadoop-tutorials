...
public class HiveJdbcClient {
	...
	public static void main(String[] args) throws SQLException {
		...
		String[] symbols = { "ATVI", "ADBE", "AKAM", "ALXN", "ALTR", "AMZN",
				"AMGN", "APOL", "AAPL", "AMAT", "ADSK", "ADP", "BIDU", "BBBY",
				"BIIB", "BMC", "BRCM", "CHRW", "CA", "CELG", "CEPH", "CERN",
				"CHKP", "CSCO", "CTXS", "CTSH", "CMCSA", "COST", "CTRP",
				"DELL", "XRAY", "DTV", "DLTR", "EBAY", "ERTS", "EXPE", "EXPD",
				"ESRX", "FFIV", "FAST", "FSLR", "FISV", "FLEX", "FLIR", "GRMN",
				"GILD", "GOOG", "GMCR", "HSIC", "ILMN", "INFY", "INTC", "INTU",
				"ISRG", "JOYG", "KLAC", "LRCX", "LINTA", "LIFE", "LLTC",
				"MRVL", "MAT", "MXIM", "MCHP", "MU", "MSFT", "MYL", "NTAP",
				"NFLX", "NWSA", "NIHD", "NVDA", "ORCL", "ORLY", "PCAR", "PAYX",
				"PCLN", "QGEN", "QCOM", "RIMM", "ROST", "SNDK", "STX", "SHLD",
				"SIAL", "SPLS", "SBUX", "SRCL", "SYMC", "TEVA", "URBN", "VRSN",
				"VRTX", "VMED", "VOD", "WCRX", "WFM", "WYNN", "XLNX", "YHOO" };

		// Moving average for 1 month on close
		System.out
				.println("----------------------------------Running for 1 months-------------------------------");
		...
		while (true) {
			...
			if ((closeSum > 0) && count != 0) {
				System.out
						.println(" moving average of AAPL is for One month window ="
								+ (closeSum) / count);
			} else {
